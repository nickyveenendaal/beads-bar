...
export const ADMIN_CUSTOMERS: AdminCustomer[] = [
  { name: "Julia M.", email: "julia.m@demo.nl", place: "Eindhoven", orders: 1, spent: 1474, lastOrder: "vandaag", tag: "nieuw", consent: true },
  { name: "Sanne K.", email: "sannek@demo.nl", place: "Groningen", orders: 4, spent: 6070, lastOrder: "vandaag", tag: "VIP", consent: true },
  { name: "Noor V.", email: "noorv@demo.be", place: "Gent", orders: 2, spent: 2540, lastOrder: "vandaag", tag: "terugkerend", consent: true },
  { name: "Femke d. B.", email: "femkedb@demo.nl", place: "Haarlem", orders: 3, spent: 4230, lastOrder: "vandaag", tag: "terugkerend", consent: false },
  { name: "Zoë P.", email: "zoep@demo.nl", place: "Breda", orders: 1, spent: 1290, lastOrder: "vandaag", tag: "nieuw", consent: true },
  { name: "Amber L.", email: "amberl@demo.nl", place: "Leiden", orders: 5, spent: 6390, lastOrder: "vandaag", tag: "VIP", consent: true },
